...
function gallery_styles() {
	...
	*/
    ...
    wp_enqueue_script('mootools',
        plugins_url($gallery_path."scripts/mootools.v1.11.js", __FILE__),
        array('jquery'),
        '1.0'
    );
    wp_enqueue_script('jdgalleryjs',
        plugins_url($gallery_path."scripts/jd.gallery.js.php", __FILE__),
        array('mootools'),
        '1.0'
    );
    wp_enqueue_script('jdgallerytrans',
        plugins_url($gallery_path."scripts/jd.gallery.transitions.js", __FILE__),
        array('jdgalleryjs'),
        '1.0'
    );
}
